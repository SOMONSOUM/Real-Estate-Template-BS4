         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-4 col-md-4">
                  <p>
                     Welcome To <strong>Osahan</strong> Property! 
                  </p>
               </div>
               ...
               <div class="collapse navbar-collapse" id="navbarResponsive">
                  ...
                  <div class="my-2 my-lg-0">
                     <ul class="list-inline main-nav-right">
                        <li class="list-inline-item">
                           <a class="btn btn btn-outline-primary btn-sm" href="login.html"><i class="mdi mdi-account-outline"></i> Sign In</a>
                        </li>
                        <li class="list-inline-item">
                           <a class="btn btn-primary btn-sm" href="register.html"><i class="mdi mdi-account-outline"></i> Sign Up</a>
                        </li>
                     </ul>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-md-12 text-center">
                  ...
                  <div class="breadcrumbs">
                     <p class="mb-0"><a href="#"><i class="mdi mdi-home-outline"></i> Home</a> / About Us</p>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-6 col-md-6 pl-5 pr-5">
                  <h2 class="mt-5 mb-5">We Provide Lovable Experiment in the Real<br> Estate Field</h2>
                  <h5 class="mt-2 text-dark">Our Vision</h5>
                  <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here,</p>
                  <h5 class="mt-4 text-dark">Our Goal</h5>
            ...
            <div class="row">
               <div class="col-lg-4 col-md-4">
                  <div class="agents-card text-center">
                     ...
                     <h6 class="mb-0 text-secondary">- Stave Martin</h6>
               ...
               <div class="col-lg-4 col-md-4">
                  <div class="agents-card text-center">
                     ...
                     <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
                     <h6 class="mb-0 text-secondary">- Mark Smith</h6>
               ...
               <div class="col-lg-4 col-md-4">
                  <div class="agents-card text-center">
                     ...
                     <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
                     <h6 class="mb-0 text-secondary">- Ryan Printz</h6>
